...
<h3>Select Your New Security Question</h3>
  ...
  <option value="What was the name of the first pet?">What was the name of the first pet?</option>
   <option value="What was your favourite dish?">What was your favourite dish?</option>
